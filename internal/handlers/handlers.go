...
import (
	...
	"github.com/lucasblopes/hotel-reservations/internal/forms"
	...
	"github.com/lucasblopes/hotel-reservations/internal/repository/dbrepo"
)
...
// AdminAllNewReservations shows all reservations in admin dashboard
...
// AdminAllNewReservations shows all new reservations in admin dashboard
...
// AdminShowReservation shows the reservation of a single room in the admin dashboard
...
func (m *Repository) AdminPostShowReservation(w http.ResponseWriter, r *http.Request) {
	...
	if year == "" {
		...
		// if it has month and year in the url, the source is the calendar page
		http.Redirect(w, r, fmt.Sprintf("/admin/reservations-calendar?y=%s&m=%s", year, month), http.StatusSeeOther)
	}
}

// AdminPostReservationsCalendar displays the reservation calander
func (m *Repository) AdminPostProcessReservation(w http.ResponseWriter, r *http.Request) {
